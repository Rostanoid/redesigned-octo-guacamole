(function () {
  ...
  const imageOverrides = {
    "Тарелка домашних солений": commons("Pickled cucumbers.jpg"),
    "Тарелка свежих овощей": commons("Vegetable platter.jpg"),
    "Тарелка грузинских сыров": commons("Georgian cheese, khachapuri, eggplant and pkhali.jpg"),
    "Тарелка грузинских закусок": commons("Pkhali, Badrijani and Ajika.jpg"),
    "Икра из баклажанов": commons("Finger food- aubergine's caviar and mint cherry tomatoes (29402673200).jpg"),
    "Рулетики из баклажанов": commons("Pkhali, Badrijani and Ajika.jpg"),
    "Ассорти пхали": commons("Пхали (Миндаль) 2020.jpg"),
    "Сациви из курицы": commons("Satsivi (2).jpg"),

    "Салат из свежих овощей": commons("Traditional Georgian salad.jpg"),
    "Салат из свежих овощей с грецким орехом": commons("Traditional Georgian salad with walnuts.jpg"),
    "Тёплый салат с куриной печенью": commons("Alinea - chicken liver.jpg"),
    "Салат Бахор с говядиной и свежими овощами": commons("Beef Salad (9152377186).jpg"),
    "Пряный салат из рваной говядины": commons("Thai Beef Salad (8476361911).jpg"),
    "Ацецили": commons("Beef Salad (9152377186).jpg"),
    "Салат с имеретинским сыром": commons("Traditional Georgian salad with cheese.jpg"),
    "Тбилисский с говядиной": commons("Beef Salad (9152377186).jpg"),

    "Оджахури из курицы": commons("Ojakhuri.JPG"),
    "Оджахури из свинины": commons("Ojakhuri.JPG"),
    "Оджахури из баранины": commons("Lamb hash.jpg"),
    "Солянка по-грузински": commons("Solyanka.jpg"),
    "Чашушули": commons("Chashushuli at restaurant Rioni.jpg"),
    "Плов с бараниной": commons("Rice pilaf.jpg"),
    "Котлеты из говядины и свинины": commons("Kotleta.JPG"),
    "Картофель жареный с грибами": commons("Fried potatoes.jpg"),
    "Курица по-мергельски": commons("Georgian chicken with hazelnuts.jpg"),
    "Запечённый сулугуни с томатами на кеци": commons("Sulguni.jpg"),
    "Цыплёнок тапака": commons("Chicken tabaka.jpg"),

    "Шашлык из курицы": commons("Cooked shashlik.JPG"),
    "Шашлык из курицы с овощами": commons("Shashlik.jpg"),
    "Шашлык из индейки": commons("Cooked shashlik.JPG"),
    "Шашлык из свинины": commons("Shashlik.jpg"),
    "Шашлык из мякоти ягнёнка": commons("Shashlik.jpg"),
    "Шашлык из каре ягнёнка": commons("Grilled lamb chops.jpg"),
    "Люля-кебаб курица": commons("Lula kebab.jpg"),
    "Люля-кебаб говядина": commons("Lula kebab 2.jpg"),
    "Ассорти шашлыков": commons("Mixed Grill Platter.jpg"),

    "Хинкали свинина и говядина": commons("Khinkali 551.jpg"),
    "Хинкали баранина": commons("Khinkali.jpg"),

    "Суп куриный": commons("Chicken soup.jpg"),
    "Борщ": commons("Borscht.jpg"),
    "Харчо": commons("Kharcho meat soup.jpg"),
    "Овощи на гриле": commons("Grilled vegetables (2).jpg"),
    "Пюре картофельное": commons("Mash Potatoes.jpg"),
    "Рис": commons("Rice pilaf.jpg"),

    "Армянский лаваш": commons("Lavash.jpg"),
    "Пури с соусом сацебели": commons("Georgian cheese, khachapuri, eggplant and pkhali.jpg"),
    "Хлебная корзина": commons("Bread basket.jpg"),
    "Аджика красная": commons("Ajika made with walnuts and red peppers.jpg"),
    "Аджика зелёная": commons("Green ajika.jpg"),
    "Сацебели": commons("Irkutsk, Georgian food, Khinkali, Satsebeli, Red wine, Russia.jpg"),
    "Чкмерули": commons("Georgian chicken with hazelnuts.jpg"),
    "Сметана": commons("Sour cream.jpg"),
    "Ткемали": commons("Tkemali.JPG"),

    "Ачма": commons("Пирог Ачма 02.jpg"),
    "Пирог с картофелем и сыром сулугуни": commons("Khachapuri.jpg"),
    "Хачапури на мангале": commons("Wikipedia 20 Forum in Kyiv 2021 обід. Хачапурі Вино 01.jpg"),
    "Хачапури по-аджарски": commons("Adjarian Khachapuri. Saint Petersburg, 2024-07-24.jpg"),
    "Хачапури по-имеретински": commons("Khachapuri.jpg"),
    "Хачапури по-мегрельски": commons("Hachapori.jpg"),
    "Хачапури по-домашнему": commons("Khachapuri.jpg"),

    "Мороженое": commons("Strawberry ice cream dessert.jpg"),
    "Грузинское варенье": commons("Walnut murabba.jpg"),
    "Мацони с мёдом и орехами": commons("Matsoni.jpg"),
    "Пахлава": commons("Baklavas.jpg"),
    "Морковный торт": commons("Carrot Cake.jpg"),
    "Шоколадный фондан": commons("Chocolate Fondant.jpg")
  };

  dishes.forEach(function (dish) {
    if (imageOverrides[dish.title]) {
      dish.image = imageOverrides[dish.title];
    }
  });
